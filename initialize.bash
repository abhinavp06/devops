...
echo "${bold}Building docker image for service-a and loading it in minikube${normal}"
cd service-a
npm i
...
cd ..
echo "${bold}------------------------------------------------------${normal}"
echo "${bold}Building docker image for service-b and loading it in minikube${normal}"
cd service-b
npm i
